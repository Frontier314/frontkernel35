...
#define GPIO_LVDS_POWER         EXYNOS4X12_GPM3(3)     // LVDS 芯片电源控制
#define GPIO_LCD_BACKLED        EXYNOS4X12_GPM3(2)     // LCD 背光电源控制

#define GPIO_WIFI_POWER         EXYNOS4X12_GPM4(5)     // wifi 外部电源控制

#define GPIO_CAMERA_POWER       EXYNOS4X12_GPM1(4)     // camera 电源控制
#define GPIO_CAMERA_F_RST       EXYNOS4X12_GPM1(2)     // 前置摄像头复位控制
#define GPIO_CAMERA_F_PWDN      EXYNOS4X12_GPM1(3)     // 前置摄像头电源控制
#define GPIO_CAMERA_B_RST       EXYNOS4X12_GPM2(3)     // 后置摄像头复位控制
#define GPIO_CAMERA_B_PWDN      EXYNOS4X12_GPM2(4)     // 后置摄像头电源控制
#define GPIO_TVP5151_RST        EXYNOS4X12_GPM4(3)     // TVP5151 复位控制
#define GPIO_TVP5151_PWDN       EXYNOS4X12_GPM4(7)     // TVP5151 电源控制
#define GPIO_FLASH_EN           EXYNOS4_GPD0(2)     // 闪光灯电源控制
#define GPIO_FLASH_MODE         EXYNOS4X12_GPM4(1)     // 闪光灯工作模式控制

#define GPIO_TP_POWER           EXYNOS4X12_GPM4(2)     // TP 电源控制
#define GPIO_TP_INT             EXYNOS4_GPX1(7)     // TP 中断信号线
#define GPIO_TP_RST             EXYNOS4_GPX1(6)     // TP 复位信号线

#define GPIO_GPS_POWER          EXYNOS4X12_GPM4(0)     // GPS 电源控制
#define GPIO_GPS_EN             EXYNOS4_GPX0(7)     // GPS 使能脚
#define GPIO_GPS_RXD            EXYNOS4_GPA0(4)     // GPS 接收数据脚

#define GPIO_3G_POWER           EXYNOS4X12_GPM3(0)     // 3G 电源控制

#define GPIO_USBHUB_POWER       EXYNOS4X12_GPM3(7)     // USB_HUB 芯片电源控制
#define GPIO_USB5V_POWER        EXYNOS4_GPX3(4)     // USB_HOST 5V 电源控制
#define GPIO_USBOTG_ID          EXYNOS4_GPX0(0)     // USB OTG ID
#define GPIO_USBOTG_POWER       EXYNOS4X12_GPM3(4)     // USB OTG 5V 电源控制
...
#define GPIO_MOTOR_POWER        EXYNOS4X12_GPM3(5)     // 震动马达电源控制
