...
#ifdef CONFIG_MACH_MIXTILE4X12
		snd_soc_write(codec, WM8960_POWER1, 0x2A);
#endif
		break;
...
#ifdef CONFIG_MACH_MIXTILE4X12
		if(head_mic_connect)
		  snd_soc_update_bits(codec, WM8960_POWER1, 0x180, 0x100, 0x02);
#else
...
#ifdef CONFIG_MACH_MIXTILE4X12
	snd_soc_update_bits(codec, WM8960_IFACE2, 0x040, 0x040);
	snd_soc_update_bits(codec, WM8960_ALC1, 0x180, 0x180);

	if(head_mic_connect)
	  snd_soc_update_bits(codec, WM8960_POWER1, 0x02, 0x02);
#endif
